 ...
 * Central configuration for white-labeling.
 * All values can be changed via environment variables.
 */
 ...
 * Central configuration for custom domains.
 */
export type Domain = {
...
export class ConfigService {
  ...
  private envProcess(): Env {
    return {
      ...
      BRANDING: {
        COMPANY_NAME: process.env.BRANDING_COMPANY_NAME || 'Next Mavens',
        PRODUCT_NAME: process.env.BRANDING_PRODUCT_NAME || 'Fidscript WhatsApp',
        LOGO_URL: process.env.BRANDING_LOGO_URL || '/assets/logo.svg',
        FAVICON_URL: process.env.BRANDING_FAVICON_URL || '/favicon.ico',
        PRIMARY_COLOR: process.env.BRANDING_PRIMARY_COLOR || '#6366f1',
        SECONDARY_COLOR: process.env.BRANDING_SECONDARY_COLOR || '#8b5cf6',
        ACCENT_COLOR: process.env.BRANDING_ACCENT_COLOR || '#06b6d4',
        SUPPORT_EMAIL: process.env.BRANDING_SUPPORT_EMAIL || 'support@nextmavens.com',
        WEBSITE_URL: process.env.BRANDING_WEBSITE_URL || 'https://nextmavens.com',
        TERMS_URL: process.env.BRANDING_TERMS_URL || 'https://nextmavens.com/terms',
        PRIVACY_URL: process.env.BRANDING_PRIVACY_URL || 'https://nextmavens.com/privacy',
      },
      DOMAIN: {
        CUSTOM_DOMAIN: process.env.DOMAIN_CUSTOM || '',
