...
/**
 * Interactive Button - New WhatsApp Business API format
 * Used for sending interactive buttons with richer button types
 */
...
export class SendInteractiveButtonsDto extends Metadata {
  header?: {
...
/**
 * Product Catalog Message - Send a single product from catalog
 */
...
/**
 * Product Carousel - Send multiple products in a carousel format
 */
...
export class SendProductCarouselDto extends Metadata {
  header: {
    text: string;
    media?: string;
    mimeType?: string;
...
/**
 * Flow Message - Send a WhatsApp Flow
 */
