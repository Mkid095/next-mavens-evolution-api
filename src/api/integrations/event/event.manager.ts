...
import { RedisEventController } from '@api/integrations/event/redis/redis.controller';
...
export class EventManager {
  ...
  private redisEventController: RedisEventController;
  ...
  constructor(prismaRepository: PrismaRepository, waMonitor: WAMonitoringService) {
    ...
    this.redisEventController = new RedisEventController(prismaRepository, waMonitor);
  }
  ...
  public async init(httpServer: Server): Promise<void> {
    ...
    this.pusher.init();
    this.kafka.init();
    await this.redisEventController.init();
  }
  ...
  public async emit(eventData: {
    ...
    // Publish to Redis Pub/Sub for platform realtime gateway
    await this.redisEventController.emit(eventData);
  }
